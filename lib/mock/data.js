...
export const SETS = [
  { id: 'OGN', code: 'OGN', name: 'Origins',                releaseDate: '2025-10-17', totalCards: 288, coverGradient: 'from-orange-600 via-red-600 to-neutral-900',      tagline: 'The dawn of the Riftbound legend. Opening set with 12 core champions.' },
  { id: 'OGS', code: 'OGS', name: 'Origins Proving Grounds', releaseDate: '2025-10-17', totalCards: 64,  coverGradient: 'from-yellow-500 via-orange-600 to-neutral-900',   tagline: 'Preconstructed starter deck for entering competitive play.' },
  { id: 'SFD', code: 'SFD', name: 'Spiritforged',           releaseDate: '2026-02-13', totalCards: 240, coverGradient: 'from-emerald-600 via-teal-700 to-neutral-900',    tagline: 'Spirit mechanic expansion — new champion synergies.' },
  { id: 'UNL', code: 'UNL', name: 'Unleashed',              releaseDate: '2026-04-25', totalCards: 180, coverGradient: 'from-purple-600 via-fuchsia-700 to-neutral-900',  tagline: 'The third set, themed around a rising from darkness.' },
  { id: 'VEN', code: 'VEN', name: 'Vendetta',               releaseDate: '2026-08-14', totalCards: 220, coverGradient: 'from-red-700 via-rose-800 to-neutral-900',        tagline: 'The fourth set, themed around revenge. Rune Fury dominates.' },
]
...
const mkListings = (base, seed) => {
  ...
  const markets = ['CardKingdom', 'TCGPlayer', 'RiftMarket', 'eBay', 'Cardmarket']
